...
export default function ProductShowcase() {
  return (
    <div className="relative w-full h-auto min-h-screen overflow-hidden">
      ...
      {/* Cards Container */}
      <div className="absolute inset-0 z-10 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 lg:gap-32 px-4 py-10">
        {/* Card 1 */}
        <div className="relative w-72 h-[450px] rounded-xl overflow-hidden shadow-xl">
        ...
        {/* Card 3 */}
        <div className="relative lg:w-72 lg:h-[450px] rounded-xl overflow-hidden shadow-xl">
          <Image src="/card3.svg" alt="Casual Wears" layout="fill" objectFit="cover" />
          <div className="absolute top-4 left-4 text-white text-sm font-semibold bg-black/40 px-2 py-1 rounded">
            CASUAL WEARS
          </div>
          <button className="absolute bottom-6 left-1/2 transform -translate-x-1/2 bg-white text-black text-xs font-semibold py-2 px-4 rounded-full shadow-md hover:bg-gray-200">
