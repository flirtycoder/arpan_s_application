  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto bg-white overflow-hidden mt-36">
      ...
      <div className="flex">
        ...
        <div className="w-full bg-gray-200 h-[662px]  items-center ">
          <div className="pl-16 pr-8">
            ...
            <button className="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-4 px-10 text-base tracking-widest transition-colors duration-300 uppercase mt-18">
              KNOW MORE
            </button>
          </div>
