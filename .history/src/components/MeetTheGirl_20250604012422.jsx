      ...
      <div className="flex">
        ...
        <div className="w-full bg-gray-200 h-[662px]  items-center ">
          <div className="pl-16 pr-8">
            ...
            <button className="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-4 px-10 text-base tracking-widest transition-colors duration-300 uppercase MT-">
              KNOW MORE
            </button>
          </div>
