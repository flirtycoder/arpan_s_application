      ...
      <div className="flex relative z-10">
        ...
        <div className="w-1/2 relative bg-white">
          <div className="ml-16 mt-8 mb-8">
            <img
              src="/girl.svg' width='400' height='350' viewBox='0 0 400 350'%3E%3Crect width='400' height='350' fill='%23000000'/%3E%3Cg fill='%23ffffff'%3E%3Ccircle cx='80' cy='120' r='25'/%3E%3Ccircle cx='150' cy='90' r='30'/%3E%3Ccircle cx='220' cy='110' r='28'/%3E%3Ccircle cx='300' cy='130' r='25'/%3E%3Ccircle cx='120' cy='180' r='20'/%3E%3Ccircle cx='260' cy='190' r='22'/%3E%3C/g%3E%3Ctext x='200' y='280' font-family='Arial' font-size='14' fill='%23888' text-anchor='middle'%3EChildren Photo Placeholder%3C/text%3E%3C/svg%3E"
