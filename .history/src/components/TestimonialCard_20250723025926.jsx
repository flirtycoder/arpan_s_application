...
export default function TestimonialCard() {
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden p-4 sm:p-6 lg:p-8 mt-20">
      ...
      {/* Main Card */}
      <div className="relative z-20 flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-80 max-w-6xl w-full px-4 sm:px-10">
        {/* Text Section */}
      ...
      {/* Dot Indicators */}
      <div className="absolute flex gap-4 z-20 bottom-6 lg:top-[98%] lg:left-[70%] justify-center lg:justify-start w-full">
