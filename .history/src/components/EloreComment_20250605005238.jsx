    ...
    <div className="relative bg-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-10 flex flex-col items-center justify-center px-4 py-20 text-white">
        <div className="max-w-6xl w-full flex flex-col md:flex-row justify-between items-start space-y-10 md:space-y-0 -mt-64">
          ...
          <div className="md:w-1/2 flex flex-col items-end">
            <input
              ...
              className="w-full md:w-96 bg-white text-black px-6 py-12 rounded-xl text-base shadow-md resize-none focus:outline-none focus:ring-2 focus:ring-black "
            />
            <button className="mt-4 bg-black text-white px-8 py-3 rounded- hover:bg-gray-800 transition-all duration-200 shadow">
              POST
            </button>
          </div>
        </div>
        ...
        <div className="mt-48 text-right ">
          <p className="text-4xl font-bold text-gray-600">GET A CHANCE TO GET</p>
          <p className="text-4xl font-bold text-gray-600">FEATURED ON ELORE</p>
        </div>
      </div>
    </div>
  );
