  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute left-[10%] top-0 h-full w-[1px] bg-gray-300" />
        {/* Horizontal line at bottom of the image */}
        <div className="absolute top-[calc(50%+200px)] left-0 w-full h-[1px] bg-gray-300" />
      </div>
      ...
      <div className="relative flex w-[80%] max-w-6xl z-10">
        ...
        <div className="z-20 w-[55%] h-[400px] overflow-hidden shadow-lg">
          <img
            src="/girl." // Replace with your actual image path
            alt="Group of Girls"
            className="w-full h-full object-cover grayscale"
          />
        </div>

        {/* Text Section (Background Style) */}
