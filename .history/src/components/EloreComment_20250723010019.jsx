  ...
  return (
    <div className="relative bg-white overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-4 py-12 md:py-20">
        <div className="max-w-6xl w-full flex flex-col md:flex-row justify-between items-center md:items-start space-y-10 md:space-y-0 md:-mt-80">
          {/* Left Side Text */}
        ...
        {/* CTA */}
        <div className="mt-12 md:mt-64 w-full text-center md:text-right md:ml-64 px-80">
          <p className="text-xl sm:text-2xl md:text-2xl font-bold text-gray-700">
            GET A CHANCE TO GET
          </p>
          <p className="text-xl sm:text-2xl md:text-2xl font-bold text-gray-700">
            FEATURED ON ELORE
