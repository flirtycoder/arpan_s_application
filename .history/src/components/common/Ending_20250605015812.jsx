  ...
  return (
    <div className="relative w-full h-[1200px] bg-[#e0e0e0] text-black overflow-hidden mt-10">
      ...
      <div className="w-full max-w-7xl mx-auto mt-32 px-6 flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="mt-10 md:mt-0 w-full max-w-md text-center md:text-center">
          <div className="flex items-center border border-gray-400 bg-white rounded-sm overflow-hidden shadow-md mt-32">
            <input
              type="email"
          ...
          <p className="mt-6 text-1xl text-gray-700 leading-relaxed">
            Subscribe now to unlock exclusive <br/>offers, early access to new arrivals,<br/> and special
            updates!
            <br />
            Be the first to experience premium<br/> deals made just for you.
            <br />
            Don’t miss out — join our community<br/> today!
          </p>
        </div>
      </div>
