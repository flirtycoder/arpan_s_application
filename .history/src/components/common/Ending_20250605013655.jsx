...
export default function Footer() {
  return (
    <div className="relative w-full h-[1200px] bg-[#e0e0e0] text-black overflow-hidden mt-10">
      ...
      <div className="w-full max-w-7xl mx-auto pt-20 px-6 grid grid-cols-4 gap-8 text-sm font-light mt-20">
        {/* ACCOUNT */}
        <div className="space-y-3">
          <h3 className="font-semibold text-xs">ACCOUNT</h3>
        ...
        {/* GET HELP */}
        <div className="space-y-3">
          <h3 className="font-semibold text-xs">GET HELP</h3>
          <ul className="space-y-2">
            <li>HELP CENTER</li>
        ...
        {/* ABOUT US */}
        <div className="space-y-3">
          <h3 className="font-semibold text-xs">ABOUT US</h3>
          <ul className="space-y-2">
