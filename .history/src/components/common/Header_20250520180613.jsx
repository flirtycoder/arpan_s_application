  ...
  return (
    <header className="bg-white backdrop-blur-sm text-black py-4">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6  text-bla">
          <button aria-label="Search">
            <Image src="/images/img_magnifyingglass.svg" alt="Search" width={24} height={24} />
          </button>
          <Link href="/account" aria-label="Account">
            <Image src="/images/img_user.svg" alt="Account" width={24} height={24} />
          </Link>
          <Link href="/cart" aria-label="Cart">
            <Image src="/images/img_shoppingcartsimple.svg" alt="Cart" width={24} height={24} />
          </Link>
        </div>
      </div>
    </header>
