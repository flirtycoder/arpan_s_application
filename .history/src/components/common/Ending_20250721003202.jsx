...
export default function Footer() {
  return (
    <div className="relative w-full bg-[#e0e0e0] text-black overflow-hidden mt-10 pt-10 pb-20">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 mt-16 flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="w-full md:w-1/2 mt-6 md:mt-0">
          ...
          <p className="mt-6 text-[15px] text-gray-700 leading-relaxed text-center md:text-left">
            Subscribe now to unlock exclusive offers, early access to new arrivals,
            and special updates! Be the first to experience premium deals made just
            for you. Don’t miss out — join our community today!
          </p>
        </div>
      </div>
    </div>
