  ...
  return (
    <div className="relative bg-white overflow-hidden min-h-screen">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        {/* Top Background */}
        <Image src="/des1.svg" alt="Top Background" fill className="object-cover w-full h-full" />
      ...
      {/* Foreground Content */}
      <div className="relative z-10 flex flex-col items-center justify-center px-4 py-32 text-white min-h-screen">
        <div className="max-w-6xl w-full flex flex-col md:flex-row justify-between items-start gap-10">
          {/* Left Text */}
