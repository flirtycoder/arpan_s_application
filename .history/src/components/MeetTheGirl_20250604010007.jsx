        ...
        <div className="w-1/2 relative bg-white">
          <div className="ml-16 mt-8 mb-8">
            ...
            */}
            ...
            <div
              className="w-full h-80 bg-cover bg-center filter grayscale relative z-20"
              style={{
                backgroundImage: "url('/girl.svg')",
              }}
            ></div>

            {/* Option 3: Using require() for local images */}
            {/* 
            <img 
              src={require('/path/to/your/image.jpg').default}
              alt="Group of smiling children"
              className="w-full h-auto filter grayscale relative z-20"
            />
            */}

            {/* Option 4: Using import statement (add at top of file) */}
            {/* 
            import childrenImage from '/path/to/your/image.jpg';
