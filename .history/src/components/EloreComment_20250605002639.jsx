...
export default function EloreComment() {
  return (
    <div className="relative bg-white overflow-hidden top-[]50%">
      ...
      <div className="w-full">
        <Image
          ...
          width={1460}
          height={1244}
          className="w-full h-auto top-[50%]"
        />
      </div>

      {/* Foreground Content */}
      <div className="relative z-10 flex flex-col items-center justify-center px-4 py-20 text-white">
