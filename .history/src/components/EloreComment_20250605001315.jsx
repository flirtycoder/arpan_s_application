...
export default function EloreComment() {
  return (
    <div className="relative min-h-screen bg-white overflow-hidden">
      ...
      <div className="absolute -top-[55%] left-0 w-full z-0">
        <Image
          src="/des1.svg"
          alt="Top Background"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-10 text-white">
        <div className="max-w-full w-full text-center space-y-6">
          ...
          <p className="text-3xl tracking-wider text-left text-gray-300">
            SEND YOUR PHOTO WITH ELORE</p><p className='text-3xl tracking-wider text-left text-gray-300'> PRODUCTS AND YOUR GENUINE</p><p> REVIEW
          </p>
          ...
          {/* CTA */}
          <p className=" text-3xl font-bold text-white">GET A CHANCE TO GET</p>
          <p className="text-3xl font-bold text-white"> FEATURED ON ELORE</p>
        </div>
      </div>
    </div>
  );
