...
export default function TestimonialCard() {
  return (
    <div className="relative w-full min-h-screen bg-black flex items-center justify-center overflow-hidden p-8 mt-20">
      {/* Background pattern image */}
      <div className="absolute inset-0 z-0">
        <img
          src="/bg1.svg" // ← Replace with your background image URL
          alt="Background pattern"
          className="w-[1441px] h-[1400px] object-cover opacity-100"
        />
      </div>
      ...
      {/* Dot indicators */}
      <div className="absolute bottom-10 flex gap-2 z-20 left-[60%] mt-20">
