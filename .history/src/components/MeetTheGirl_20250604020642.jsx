  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative w-[80%] max-w-6xl flex items-start">
        ...
        <div className="absolute left-[40%] top-[60px] bg-gray-300 rounded-bl-2xl p-10 pl-24 shadow-md w-[50%] z-10">
          <p className="text-2xl italic text-black mb-6 ml-48 leading-snug">
            Meet The Girl
            <br />
            You're Helping
          </p>
          <button className="bg-gray-400 text-white py-2 px-6 rounded-full text-sm hover:bg-gray-500 ml-48 transition">
            KNOW MORE
          </button>
