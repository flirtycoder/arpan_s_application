      ...
      <div className="relative z-20 flex items-center gap-8 max-w-4xl p-6">
        ...
        <div className="flex flex-col items-center text-white text-center max-w-sm">
          ...
          <p className="text-sm mt-3 font-light leading-relaxed px-2">
            “As a fashion{' '}
            <p className="text-sm font-light leading-relaxed px-2">influencer, I love</p>{' '}
            <p className="text-sm font-light leading-relaxed px-2">the comfort and </p>
            <p className="text-sm font-light leading-relaxed px-2">the elegant</p>{' '}
            <p className="text-sm font-light leading-relaxed px-2">design Elore have</p>
            <p className="text-sm font-light leading-relaxed px-2"> in their catalog.</p>
            <p className="text-sm font-light leading-relaxed px-2"> MORE LOVE TO </p><p></p>ELORE”
          </p>
        </div>
