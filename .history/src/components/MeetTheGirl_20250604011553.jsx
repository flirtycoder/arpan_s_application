...
export default function MeetTheGirl() {
  return (
    <div className="relative w-full max-w-6xl mx-auto bg-white overflow-hidden mt-36">
      ...
      <div className="absolute left-24 top-0 w-1 h-full bg-gray-300 z-0"></div>
      <div className="absolute bottom-0 left-16 w-96 h-1 bg-gray-300 z-0"></div>
        ...
        <div className="w-full  bg-white">
          <div className="ml-16 mt-8 mb-8">
            ...
            <img
              ...
              className="w-full h-[812px] h-auto filter grayscale relative z-20"
            />
          </div>
        </div>
