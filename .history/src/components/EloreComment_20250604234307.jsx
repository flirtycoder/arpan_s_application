  ...
  return (
    <div className="relative min-h-screen bg-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[827px] z-0">
        <Image
          src="/top-shape.png" // Replace with your top background image
          alt="Top Background"
          layout="fill"
          objectFit="cover"
      ...
      <div className="absolute bottom-0 left-0 w-full h-[827px] z-0">
        <Image
          src="/bottom-shape.png" // Replace with your bottom background image
