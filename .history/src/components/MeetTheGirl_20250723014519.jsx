...
export default function MeetTheGirl() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-white overflow-hidden px-4 lg:px-20">
      ...
      <div className="relative bg-gray-300 rounded-lg p-6 sm:p-10 shadow-md w-full lg:w-[50%] lg:pl-24 lg:pt-16 order-2 lg:order-1">
        <p className="text-2xl italic text-black leading-snug text-center lg:text-left mt-4 lg:mt-12">
          Meet The Girl
          <br />
          You're Helping
        </p>
