...
const page = () => {
    return (
      <div>
        ...
        <Footer />
        <div
          className="relative bg-white text-gray-800 font-light mx-auto px-10 py-14"
          style={{ width: '1005px', height: '1044px' }}
        >
          {/* Bottom-right decorative image */}
          <div className="absolute bottom-0 right-0 w-[617px] h-[641px] pointer-events-none">
            <Image
              src="/images/faq-art.png" // ✅ Replace with your image path
              alt="FAQ Art"
              layout="fill"
              objectFit="contain"
            />
          ...
          <div className="max-w-3xl">
            ...
            <ol className="space-y-6 list-decimal ml-4">
              ...
              <li>
                ...
                <p>
                  Yes, you can request a return within 7 days of delivery. The product must be
