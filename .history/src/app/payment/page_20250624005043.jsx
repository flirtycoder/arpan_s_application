  ...
  return (
    <div>
      ...
      <div className="min-h-screen px-6 md:px-32 py-10 bg-white text-gray-800 font-light">
        <h1 className="text-6xl md:text-4xl font-serif mb-10">Payment & Delivery Policy</h1>

        {/* Payment Section */}
        <div className="mb-12 space-y-4">
          <div>
            <h2 className="font-semibold text-3xl">Payment:</h2>
            <p>
          ...
          <div>
            <h2 className="font-semibold">Cash on Delivery (COD):</h2>
