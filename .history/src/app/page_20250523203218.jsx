...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-10 bg-[#2b3a33] bg-opacity-90">
        {/* Left image block (you insert the image) */}
        <div className="w-full md:w-1/2 p-4">
          <div className="rounded-tl-[60px] rounded-br-[60px] overflow-hidden shadow-lg mr-20">
            <Image
              src="/green1.svg" // Replace with your actual image
              alt="Collection Shoe"
              width={600}
              height={400}
