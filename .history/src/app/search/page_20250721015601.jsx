...
const Page = () => {
  return (
    <div className="relative bg-white min-h-screen overflow-hidden">
      {/* 🔽 Background Image in Left-Bottom Corner */}
      ...
      {/* Product Images in Masonry Layout */}
      <div className="columns-2 sm:columns-3 md:columns-4 gap-4 space-y-4 px-4 sm:px-10 md:px-20 relative z-10">
