...
const Page = () => {
  return (
    <div className="relative bg-white min-h-screen sm:px-6 py-10 overflow-hidden">
      {/* Background SVG – fully visible and behind */}
      <img
        src="/search.svg"
        alt="Background SVG"
        className="absolute left-0 bottom-0 w-[926px] h-[969px] object-contain -z-10 pointer-events-none"
      />
      ...
      {/* Masonry Layout */}
      <div className="columns-2 sm:columns-3 md:columns-4 gap-4 space-y-4 px-2 relative z-10">
