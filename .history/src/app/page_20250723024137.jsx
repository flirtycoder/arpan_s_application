...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      {/* Product Swiper */}
      <div className="w-full bg-white py-8 px-2 overflow-x-visible">
        <Swiper
          spaceBetween={3}
            ...
            <SwiperSlide key={index}>
              <div className="flex items-center justify-center h-48 md:h-64">
                <img
                  src={src}
                  alt={`Product ${index + 1}`}
                  className="w-48 h-80 md:w-48 md:h-80 object-contain"
                />
              </div>
            </SwiperSlide>
          ))}
      ...
      >
        <div className="w-full md:w-1/2 md:justify-start flex justify-center md:justify-start">
