...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section
        className="w-full flex flex-col md:flex-row items-center justify-center px-4 py-10 bg-cover bg-center"
        style={{
          backgroundImage: "url('/Asset 1.svg')", // Replace with your actual image path
        }}
      >
        {/* Left image block */}
        <div className="w-full md:w-1/2 p-4 mr-30 ">
          <div className="rounded-tl-[60px] rounded-br-[60px] overflow-hidden shadow-lg ">
            <Image
              src="/green1.svg" // Replace with your actual shoe image
              alt="Collection Shoe"
              width={637}
              height={580}
              className="w-full h-auto object-cover mt"
            />
          </div>
        </div>

        {/* Right text block */}
        <div className="w-full md:w-1/2 p-6 text-white text-right md:text-right space-y-10 ">
          <h2 className="text-4xl font-[cursive]">elore&apos;s Collection</h2>
          ...
          <button className="bg-gray-100 text-gray-800 px-6 py-2 rounded-l-full rounded-r-md font-semibold hover:bg-gray-200 transition-all duration-300">
            CHECKOUT COLLECTION
          </button>
        </div>
      </section>
