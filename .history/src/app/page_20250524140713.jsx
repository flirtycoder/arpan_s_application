...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section
        className="w-full flex flex-col md:flex-row items-start justify-between px-4 py-10 bg-cover bg-center"
        style={{
          backgroundImage: "url('/Asset 1.svg')", // Replace with your actual background image path
        }}
      >
        {/* Left image block */}
        <div className="w-full md:w-1/2 p-4 flex justify-start items-start">
        ...
        {/* Right text block */}
        <div className="w-full md:w-1/2 p-6 text-white text-right space-y-10 flex flex-col justify-center items-end">
