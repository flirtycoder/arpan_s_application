    ...
    <div>
      ...
      <div className="space-y-6 max-w-3xl">
        <div>
          ...
          <p>All orders are processed and dispatched within 1–3 business days.</p>
        </div>

        <div>
          <h2 className="font-semibold">Delivery Time:</h2>
          <p>Once shipped, orders usually arrive within 4–7 business days, depending on your location</p>
        </div>
        ...
        <div>
          ...
          <p><strong>Cash on Delivery (COD):</strong> Nominal COD fee may apply</p>
        </div>
