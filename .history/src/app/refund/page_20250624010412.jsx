    ...
    <div>
      ...
      <div className="min-h-screen px-6 md:px-32 py-10 bg-white text-gray-800 font-light">
        ...
        <div className="max-w-3xl">
          <p>
            Email us at <span className="font-medium text-black">[your email]</span> with your order
            ID and reason for return. Once approved, we’ll arrange a reverse pickup.
          </p>
        </div>
      </div>
      <Ending />
