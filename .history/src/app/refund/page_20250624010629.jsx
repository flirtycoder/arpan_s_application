  ...
  return (
    <div>
      ...
      <div className="min-h-screen px-6 md:px-32 py-10 bg-white text-gray-800 font-light">
        ...
        {/* Returns Process */}
        <h2 className="text-2xl font-serif mb-6">Returns Process:</h2>
        <div className="max-w-3xl">
          <p className="text-3xl ml-20">
            Email us at <span className="font-medium text-black">[info@elorelifestyle.com</span>{' '}
            with your order ID and reason for return. Once approved, we’ll arrange a reverse pickup.
          </p>
        </div>
      </div>
      <Ending />
