    ...
    <div className="relative bg-white min-h-screen overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row bg-white p-4 lg:p-6 gap-6">
        ...
        {(showFilters || typeof window === 'undefined') && (
          <aside className={`lg:w-1/4 w-full ${showFilters ? '' : 'hidden lg:block'}`}>
              ...
              <div>
                ...
                <div className="grid grid-cols-5 gap-2">
                  {['36', '37', '38', '39', '40'].map((size, i) => (
                    <button
                      key={i}
                      className="border px-2 py-1 text-sm hover:bg-black hover:text-white"
                    >
                      {size}
                    </button>
                  ))}
        ...
        {/* Product Grid */}
        <main className="w-full grid grid-cols-2 sm:grid-cols-3 gap-6">
