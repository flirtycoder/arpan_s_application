  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <div className=" text-right mr-20 mt-2">
        <p className="text-6xl font-[cursive] ">Elore's Happy</p>
        <p className="text-6xl font-[cursive] ">Family</p>
        <p className="text-left  text-3xl -mt-10 ml-16">See what our Happy </p>
        <p className="text-left  text-3xl ml-16">Customers Have To Say</p>
      </div>
      <main>
        <TestimonialCard />
      </main>
      ...
      <Image src="/golswer,l.svg" alt="Decorative Curve" fill />
    </main>
  );
}
