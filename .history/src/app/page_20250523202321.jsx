  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center py-12 bg-white">
        {/* Heading */}
        <h2 className="text-center font-[cursive] text-base text-black leading-tight tracking-wide text-4xl">
          SEE WHAT EVERYONE <br /> LOVES
        </h2>

        {/* Button */}
        <button className="mt-4 px-8 py-3 bg-gray-300 rounded-l-full text-black font-bold shadow-sm hover:bg-gray-400 transition-all duration-200">
          CLICK HERE
        </button>
